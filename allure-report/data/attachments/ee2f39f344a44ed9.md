...
- Name: Assignments/Assignment3.spec.js >> Test 1 - Banner IS visible when 6 events are returned
- Location: tests/Assignments/Assignment3.spec.js:151:1
...
Call log:
  ...
  - waiting for getByText('Browse Events →')
    7 × waiting for "https://eventhub.rahulshettyacademy.com/login" navigation to finish...
...
```ts
  67  |       eventDate: "2025-06-20T12:00:00.000Z",
  68  |       venue: "Mahalaxmi Racecourse",
  69  |       city: "Mumbai",
  70  |       price: "3000",
  71  |       totalSeats: 5000,
  72  |       availableSeats: 2000,
  73  |       imageUrl: null,
  74  |       isStatic: false,
  75  |     },
  76  |     {
  ...
  80  |       eventDate: "2025-06-25T10:00:00.000Z",
  81  |       venue: "Bangalore International Exhibition Centre",
  82  |       city: "Bangalore",
  83  |       price: "750",
  84  |       totalSeats: 300,
  85  |       availableSeats: 180,
  86  |       imageUrl: null,
  87  |       isStatic: false,
  88  |     },
  89  |   ],
  90  |   pagination: { page: 1, totalPages: 1, total: 6, limit: 12 },
  91  | };
  92  | 
  93  | const FOUR_EVENTS_RESPONSE = {
  94  |   data: [
  95  |     {
  96  |       id: 1,
  97  |       title: "Tech Summit 2025",
  98  |       category: "Conference",
  99  |       eventDate: "2025-06-01T10:00:00.000Z",
  100 |       venue: "HICC",
  101 |       city: "Hyderabad",
  102 |       price: "999",
  103 |       totalSeats: 200,
