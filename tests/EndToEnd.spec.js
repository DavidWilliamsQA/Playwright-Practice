...
test("@Web End to End test: Logging into the application, adding an item to the cart, checking out, getting the order number and checking the order appears in the list of orders", async ({
  browser,
}) => {
